...
from src.cleaning.transform_structure import household_members_to_long_format, household_questions_to_long_format
...
def main():
    ...
    household_questions_long = household_questions_to_long_format(household_clean)
    export_household_answers_to_csv(household_questions_long)
